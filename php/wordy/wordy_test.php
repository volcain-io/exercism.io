...
class WordProblemTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testMultiplyTriple(): void
    {
        $this->assertEquals(-48, calculate('What is 2 multiplied by -2 multiplied by 3 multiplied by 4?'));
    }
    ...
    {
        $this->assertEquals(0.125, calculate('What is 2 raised to the -3rd power?'));
    }
